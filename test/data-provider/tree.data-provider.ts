export class TreeDataProvider {
  public static treeModelSettings: any = {
    ...
    'first node property of templates has higher priority': {
      ...
      result: { isCollapsedOnInit: false, static: false, leftMenu: false, rightMenu: true, checked: false, templates: { node: '<i class="folder-o"></i>', leaf: '<i class="file"></i>', leftMenu: '<i class="navigation"></i>' } }
    },
    'first leaf property in templates has higher priority': {
      treeModelA: { value: '12', settings: { templates: { leaf: '<i class="file-o"></i>' } } },
      treeModelB: { value: '42', settings: { templates: { node: '<i class="folder"></i>', leaf: '<i class="file"></i>', leftMenu: '<i class="navigation"></i>' } } },
      result: { isCollapsedOnInit: false, static: false, leftMenu: false, rightMenu: true, checked: false, templates: { node: '<i class="folder"></i>', leaf: '<i class="file-o"></i>', leftMenu: '<i class="navigation"></i>' } }
    },
    'first leftMenu property in templates has higher priority': {
      ...
      treeModelB: { value: '42', settings: { templates: { node: '<i class="folder"></i>', leaf: '<i class="file"></i>', leftMenu: '<i class="navigation"></i>' } } },
      result: { isCollapsedOnInit: false, static: false, leftMenu: false, rightMenu: true, checked: false, templates: { node: '<i class="folder"></i>', leaf: '<i class="file"></i>', leftMenu: '<i class="navigation-o"></i>' } }
    },
    'first properties of templates has higher priority': {
      ...
      treeModelB: { value: '42', settings: { templates: { node: '<i class="folder"></i>', leaf: '<i class="file"></i>', leftMenu: '<i class="navigation"></i>' } } },
      result: { isCollapsedOnInit: false, static: false, leftMenu: false, rightMenu: true, checked: false, templates: { node: '<i class="folder-o"></i>', leaf: '<i class="file-o"></i>', leftMenu: '<i class="navigation-o"></i>' } }
    },
    'second properties of templates in settings has priority, if first source doesn\'t have them': {
      ...
      result: { isCollapsedOnInit: false, static: true, leftMenu: true, rightMenu: false, checked: false, templates: { node: '<i class="folder-o"></i>', leaf: '<i class="file-o"></i>', leftMenu: '<i class="navigation-o"></i>' } }
    }
  };
}
